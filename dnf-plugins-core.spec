...
Version  : 4.0.22
Release  : 39
URL      : https://github.com/rpm-software-management/dnf-plugins-core/archive/4.0.22/dnf-plugins-core-4.0.22.tar.gz
Source0  : https://github.com/rpm-software-management/dnf-plugins-core/archive/4.0.22/dnf-plugins-core-4.0.22.tar.gz
...
%prep
%setup -q -n dnf-plugins-core-4.0.22
cd %{_builddir}/dnf-plugins-core-4.0.22
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630023137
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dnf-plugins-core-4.0.22/COPYING %{buildroot}/usr/share/package-licenses/dnf-plugins-core/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
